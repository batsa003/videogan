...
class DataLoader(object):
    ...
    def __init__(self, batch_size = 5):
        ...
        print len(self.video_index)

    def get_batch(self, type_dataset='train'): # Returns 
        if type_dataset not in('train', 'test'):
            print 'type_dataset = ', type_dataset, ' is invalid'
            return 
        ...
        for idx in xrange(self.batch_size):
            ...
            for j in xrange(self.frame_size):
                ...
                for cc in range(3):
                    temp_out[cc,:,:] -= temp_out[cc,:,:].mean() # Not too sure. (According to Line 123 in donkey_video2.lua)
